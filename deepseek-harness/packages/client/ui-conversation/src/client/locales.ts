...
export const zh = {
  ...
  'placeholder.default': '輸入指令或指派任務… / 調用指令 @ 文件或會話',
  'placeholder.unavailable': '会话不可用',
  'placeholder.parentOffline': '父会话已离线，无法继续发送；仍可停止当前运行',
  'placeholder.hero': '輸入任務指令或工程目標… / 調用指令 @ 文件或會話',
  ...
  'hero.headline': '智構萬象，樞聯無疆',
  'hero.subline': '全自主工程調度 · 多模型協同工作空間',
  'hero.cap.arch.title': '架構重構與調度',
  'hero.cap.arch.desc': '跨文件深度理解與全庫重構',
  'hero.cap.arch.prompt': '請分析當前工程架構並提供重構與模組優化方案',
  'hero.cap.security.title': '安全審查與防禦',
  'hero.cap.security.desc': '敏感指令審批與代碼漏洞掃描',
  'hero.cap.security.prompt': '對當前工作區執行全方位代碼安全性與漏洞審查',
  'hero.cap.moa.title': '多模型協同 (MoA)',
  'hero.cap.moa.desc': '多維思考鏈綜合交叉裁決',
  'hero.cap.moa.prompt': '使用多模型協同架構對當前設計方案進行交叉評審',
  'hero.cap.testing.title': '自動化測試迴圈',
  'hero.cap.testing.desc': '自適應測試生成與閉環修復',
  'hero.cap.testing.prompt': '檢查現有測試覆蓋率並為核心模組補充自適應單元測試',
...
export const en = {
  ...
  'hero.headline': 'Architecting Intelligence, Connecting Frontiers',
  'hero.subline': 'Autonomous Engineering & Multi-Agent Collaboration Space',
  'hero.cap.arch.title': 'Architecture & Refactor',
  'hero.cap.arch.desc': 'Cross-file comprehension & codebase refactoring',
  'hero.cap.arch.prompt': 'Analyze current architecture and propose modular refactoring plan',
  'hero.cap.security.title': 'Security & Guardrails',
  'hero.cap.security.desc': 'Sensitive command inspection & vulnerability audit',
  'hero.cap.security.prompt': 'Perform comprehensive security and vulnerability audit on current workspace',
  'hero.cap.moa.title': 'Multi-Model Consensus',
  'hero.cap.moa.desc': 'Multi-agent cross-verification & arbitration',
  'hero.cap.moa.prompt': 'Use multi-model collaboration to review and arbitrate current architectural decisions',
  'hero.cap.testing.title': 'Automated Test Loop',
  'hero.cap.testing.desc': 'Adaptive test generation & regression closure',
  'hero.cap.testing.prompt': 'Inspect test coverage and generate adaptive unit tests for core modules',
