...
function HeroFish({ hovering: _hovering }: { hovering: boolean }) {
  return (
    <span className={css.heroLogoContainer}>
      <img src="/logo.png" width={76} height={76} alt="Aiapi" className={css.heroLogoLight} />
      <img src="/logo-dark.png" width={76} height={76} alt="Aiapi" className={css.heroLogoDark} />
    </span>
  )
}

/**
 * Render the hero chrome (logo on the left of headline text, large bold style).
    ...
    <div className={css.root}>
      <div className={css.stack}>
        <div className={css.headline}>
          <span className={css.heroLogoWrapper}>
            {renderSlot('conversation.hero.brand.mark', { size: 76 }, {
