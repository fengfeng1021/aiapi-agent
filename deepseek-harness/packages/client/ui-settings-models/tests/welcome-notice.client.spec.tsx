...
describe('WelcomeNotice', () => {
  it('uses the exact owner copy in both GUI locales', () => {
    expect(WELCOME_NOTICE_COPY.en).toEqual({
      title: 'Welcome to Aiapi Agent',
      body: "Aiapi Agent is an autonomous coding assistant powered by Codex v2 and dynamic multi-model synergy (MoA).\n\nSeamlessly orchestrate reasoning models, local tools, and collaborative subagents across projects.",
