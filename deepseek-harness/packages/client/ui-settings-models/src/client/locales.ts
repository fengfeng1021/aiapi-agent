...
export const en = {
  ...
  creating: 'Creating\u2026',
  welcomeTitle: 'Welcome to Aiapi Agent',
  welcomeBody: "Aiapi Agent is an autonomous coding assistant powered by Codex v2 and dynamic multi-model synergy (MoA).\n\nSeamlessly orchestrate reasoning models, local tools, and collaborative subagents across projects.",
  welcomeContinue: 'Continue',
  welcomeError: 'The acknowledgement could not be saved. Please try again.',
  onboardingTitle: 'Add an API key to get started',
  onboardingDescription: 'Configure the Aiapi provider to start building.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  fetchTitle: '选择要启用的模型',
  fetchDescription: '以下是模型提供方的可用模型，勾选要使用的模型。',
  fetchSelectAll: '全选',
  fetchDeselectAll: '取消全选',
  fetchEmpty: '该提供方未返回任何模型，请手动添加。',
  fetchAdopt: '应用所选',
  customAdd: '添加自定义提供方',
  customTitle: '自定义提供方',
  customTag: '自定义',
  ...
  create: '创建提供方',
  creating: '创建中\u2026',
  welcomeTitle: '歡迎使用 Aiapi Agent',
  welcomeBody: 'Aiapi Agent 是一款基於 Codex v2 與混合模型協同（MoA）的高階智能編程代理軟體。\n\n系統整合多模型盲區協同、終端工具調用與子代理協同架構，為您提供無縫的端到端開發體驗。',
  welcomeContinue: '继续',
  welcomeError: '暂时无法保存确认状态，请重试。',
  onboardingTitle: '添加一个 API Key 开始使用',
  onboardingDescription: '配置 Aiapi 提供商，即可开始使用。',
