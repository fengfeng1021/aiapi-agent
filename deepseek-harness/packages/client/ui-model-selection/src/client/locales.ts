...
/** Simplified/Traditional Chinese dictionary (the key-set source of truth). */
export const zh = {
  ...
  'trigger.ariaEffort': '选择模型，当前 {model}，推理程度 {effort}',
  'menu.aria': '模型与推理程度',
  'menu.model': '模型',
  'menu.effort': '推理程度',
  'effort.providerDefault': '預設 (Default)',
