...
function SidebarBrandLogo({ size = 24 }: { size?: number }) {
  return (
    <span className={css.brandMarkContainer} style={{ width: size, height: size }}>
      <img src="/logo.png" width={size} height={size} alt="Aiapi" className={css.brandLogoLight} />
      <img src="/logo-dark.png" width={size} height={size} alt="Aiapi" className={css.brandLogoDark} />
    </span>
  )
}
          ...
          >
            <span className={css.brandIdentity} aria-hidden="true">
              <span className={css.brandMark}>
                {renderSlot('sidebar.brand.mark', { size: 24 }, { fallback: <SidebarBrandLogo size={24} /> })}
              </span>
