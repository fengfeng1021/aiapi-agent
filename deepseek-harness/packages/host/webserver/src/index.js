...
import { handleAntigravityRequest } from "./antigravity-forwarder.js";
import { handleOAuthRequest } from "./oauth-forwarder.js";
export { renderIndexInjections } from "./injections.js";
export { handleAntigravityRequest } from "./antigravity-forwarder.js";
export { handleOAuthRequest } from "./oauth-forwarder.js";
...
export class WebServer extends Service {
    ...
    constructor(ctx, config) {
        ...
        this.register({
            ...
            handler: handleAntigravityRequest,
        });
        this.register({
            kind: 'prefix',
            path: '/api/oauth',
